...
/datum/controller/rogue
	...
	var/mobs = list(
		...
		"tier3" = list(/mob/living/simple_animal/hostile/carp, /mob/living/simple_animal/hostile/goose,
						/mob/living/simple_animal/hostile/bear/vore, /mob/living/simple_animal/hostile/carp/strong),

		"tier4" = list(/mob/living/simple_animal/hostile/carp, /mob/living/simple_animal/hostile/goose, /mob/living/simple_animal/hostile/bear/vore,
						/mob/living/simple_animal/hostile/carp/strong, /mob/living/simple_animal/hostile/carp/pike/weak),

		"tier5" = list(/mob/living/simple_animal/hostile/carp, /mob/living/simple_animal/hostile/bear/vore, /mob/living/simple_animal/hostile/carp/pike/weak,
						/mob/living/simple_animal/hostile/carp/strong, /mob/living/simple_animal/hostile/carp/pike),

		"tier6" = list(/mob/living/simple_animal/hostile/bear/vore, /mob/living/simple_animal/hostile/carp/strong,
